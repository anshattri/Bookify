...
export default function Login() {
    ...
    return (
        ...
        <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
            <div className="relative left-7 bottom-5">
            <Link to="/" className='block'><button className='bg-blue-500 text-white font-semibold px-4 py-2 rounded hover:bg-black transition-all duration-300 '>back :-</button></Link>
            </div>
            <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                ...
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div className="max-w-md mx-auto">
                        <div>
                            <h1 className="text-3xl font-semibold">Please Login as Author</h1>
                        </div>
